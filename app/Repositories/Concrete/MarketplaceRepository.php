...
class MarketplaceRepository implements MarketplaceRepositoryInterface
{
    ...
    public function getCategories(int $marketplaceId, bool $activeOnly = true): array
    {
        ...
        return $this->cacheService->remember($cacheKey, function ($marketplaceId, $activeOnly) {
    ...
    public function getTopSellingProducts(int $marketplaceId, int $limit = 10, string $period = 'month'): array
    {
        ...
        return $this->cacheService->remember($cacheKey, function ($marketplaceId, $period) {
    ...
    {
        throw new \RuntimeException('Method countProducts belum diimplementasikan.');
    }

    public function findWithoutActiveLinks(bool $activeOnly = true, int $limit = 50): array
    {
        throw new \RuntimeException('Method findWithoutActiveLinks belum diimplementasikan.');
    }

    public function getRevenueRanking(string $period = 'month', int $limit = 10): array
    {
        throw new \RuntimeException('Method getRevenueRanking belum diimplementasikan.');
    }

    public function getClickRanking(string $period = 'month', int $limit = 10): array
    {
        throw new \RuntimeException('Method getClickRanking belum diimplementasikan.');
    }

    public function getConversionRanking(string $period = 'month', int $limit = 10): array
    {
        throw new \RuntimeException('Method getConversionRanking belum diimplementasikan.');
    }

    public function getPerformanceComparison(array $marketplaceIds, string $period = 'month'): array
    {
        throw new \RuntimeException('Method getPerformanceComparison belum diimplementasikan.');
    }
    ...
    {
        throw new \RuntimeException('Method hasAffiliateProgram belum diimplementasikan.');
    }

    public function supportsFeatures(int $marketplaceId, array $features): array
    {
        throw new \RuntimeException('Method supportsFeatures belum diimplementasikan.');
    }
    ...
    {
        throw new \RuntimeException('Method getDefaults belum diimplementasikan.');
    }

    public function createDefaultMarketplaces(): array
    {
        throw new \RuntimeException('Method createDefaultMarketplaces belum diimplementasikan.');
    }

    public function getSuggestions(?string $query = null, bool $activeOnly = true, int $limit = 20): array
    {
        throw new \RuntimeException('Method getSuggestions belum diimplementasikan.');
    }

    public function getAllowedDomains(int $marketplaceId): array
    {
        throw new \RuntimeException('Method getAllowedDomains belum diimplementasikan.');
    }

    public function getConfiguration(int $marketplaceId): array
    {
        throw new \RuntimeException('Method getConfiguration belum diimplementasikan.');
    }

    public function updateConfiguration(int $marketplaceId, array $config): bool
    {
        throw new \RuntimeException('Method updateConfiguration belum diimplementasikan.');
    }

    public function getIconUrl(int $marketplaceId, string $size = 'medium'): ?string
    {
        throw new \RuntimeException('Method getIconUrl belum diimplementasikan.');
    }

    public function generateReport(int $marketplaceId, string $period = 'month', string $format = 'array')
    {
        throw new \RuntimeException('Method generateReport belum diimplementasikan.');
    }

    public function isPopular(int $marketplaceId, int $threshold = 100): bool
    {
        throw new \RuntimeException('Method isPopular belum diimplementasikan.');
    }
