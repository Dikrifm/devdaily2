...
final class ProductResponse
{
    ...
    private function resolveImageUrl(Product $product): ?string
    {
        ...
        if ($imageSourceType === ImageSourceType::UPLOAD) {
    ...
    public function toAdminArray(): array
    {
        ...
        if ($this->includeTrashed) {
            ...
            $data['is_deleted'] = !empty($this->deletedAt);
        }
    ...
    public function getImageSourceType(): ?string { return $this->imageSourceType; }
    ...
    public function getCategoryIcon(): ?string { return $this->categoryIcon; }
    ...
    public function getLastPriceCheck(): ?string { return $this->lastPriceCheck; }
    public function getLastLinkCheck(): ?string { return $this->lastLinkCheck; }
    ...
    public function getBaseImageUrl(): string { return $this->baseImageUrl; }
